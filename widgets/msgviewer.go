...
func NewMessageViewer(acct *AccountView,
	conf *config.NyatConfig, msg lib.MessageView) *MessageViewer {
...
func enumerateParts(acct *AccountView, conf *config.NyatConfig,
...
func createSwitcher(acct *AccountView, switcher *PartSwitcher,
	conf *config.NyatConfig, msg lib.MessageView) error {
...
func NewPartViewer(acct *AccountView, conf *config.NyatConfig,
	...
	selector := NewSelector([]string{"Save message", "Pipe to command"},
		...
		OnChoose(func(option string) {
			switch option {
			case "Save message":
				acct.nyat.BeginExCommand("save ")
			case "Pipe to command":
				acct.nyat.BeginExCommand("pipe ")
			}
		})
